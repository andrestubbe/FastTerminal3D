...
public class DemoTileTerminal {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            FastTerminal.setTitle(String.format("FPS: %d | X: %.2f, Y: %.2f, Z: %.2f | SSAA: %dx | Mipmap Mode: %s", (int) Math.round(realFps), camera.x, camera.y, camera.z, controller.getSsaaFactor(), modeStr));
